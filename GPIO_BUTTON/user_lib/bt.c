...
__weak void btn_pressing_callback(void)
{
	
}


__weak void btn_release_callback(void)
{
}


__weak void btn_press_short_callback(void)
{
}


__weak void btn_press_timeout_callback(void)
{
}
